...
*/
package at.ac.tuwien.dsg.sybl.monitorandenforcement.monitoringPluginManagement;
...
public class OfferedMonitoringMetrics implements MonitoringInterface{
	...
	public String getLatestMonitoringData() {
		...
		for (Method method:methods.keySet()){
			System.out.println(method.getName());
			if (method.getName().equalsIgnoreCase("getLatestMonitoringData")){
				 result = methods.get(method).getLatestMonitoringData();
			}
		}
		return result;
	}
