...
public class MetricValue implements Comparable<MetricValue> {
    ...
    public enum ValueType {
        @XmlEnumValue("NUMERIC")NUMERIC, @XmlEnumValue("TEXT")TEXT, @XmlEnumValue("ENUMERATION")ENUM
    }
...
//        return new MetricValue(cloneValue);
    ...
    /**
     * @param o
     * @return Used to compare different metric values.
     *         Currently is returns 0 if the values can;t be compared.
     */
    @Override
