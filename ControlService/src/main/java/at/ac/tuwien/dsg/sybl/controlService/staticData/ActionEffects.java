...
*/
package at.ac.tuwien.dsg.sybl.controlService.staticData;
...
public class ActionEffects {
	...
	public static HashMap<String,List<ActionEffect>> getActionEffects(DependencyGraph dependencyGraph,SyblAPIService syblAPI){
		...
		
		{
			...
			scaleOutEffectForCassandraDB.setActionEffectForMetric("cpu.usage", -40.0f,"CassandraNode");
			scaleOutEffectForCassandraDB.setActionEffectForMetric("mem.usage", -40.0f,"CassandraNode");
			scaleOutEffectForCassandraDB.setActionEffectForMetric("latency.average", -30.0f,"CassandraNode");
			scaleOutEffectForCassandraDB.setActionEffectForMetric("cost.PerHour", 0.001f*3600,"CassandraNode");
			scaleOutEffectForCassandraDB.setActionName("scaleOutEffectForCassandraNode");
		...
		{
			scaleOutEffectForWebServer.setTargetedEntityID("WebService") ; 
			scaleOutEffectForWebServer.setActionEffectForMetric("cpu.usage", -40.0f,"WebService");
			scaleOutEffectForWebServer.setActionEffectForMetric("cost.PerHour", 0.001f*3600,"WebService");
			scaleOutEffectForWebServer.setActionEffectForMetric("responseTime", -1000.0f,"WebService");
			scaleOutEffectForWebServer.setActionEffectForMetric("throughput", 1000f,"WebService");
			scaleOutEffectForWebServer.setActionName("scaleOutEffectForWebService");
...
//		}
...

		{
			...
			scaleInEffectForCassandraDB.setActionEffectForMetric("cpu.usage", 4.0f,"CassandraNode");
			scaleInEffectForCassandraDB.setActionEffectForMetric("mem.usage", 40.0f,"CassandraNode");
			scaleInEffectForCassandraDB.setActionEffectForMetric("latency.average", 0.001f,"CassandraNode");
			scaleInEffectForCassandraDB.setActionEffectForMetric("cost.PerHour", -30.0f,"CloudService");
			scaleInEffectForCassandraDB.setActionName("scaleInEffectForCassandraNode");
		...
		{
			scaleInEffectForWebServer.setTargetedEntityID("WebService") ; 
			scaleInEffectForWebServer.setActionEffectForMetric("cpu.usage", 40.0f,"WebService");
			scaleInEffectForWebServer.setActionEffectForMetric("cost.PerHour", 0.0f,"WebService");
			scaleInEffectForWebServer.setActionEffectForMetric("responseTime", 400.0f,"WebService");
			scaleInEffectForWebServer.setActionEffectForMetric("throughput", -1000.0f,"WebService");
			scaleInEffectForWebServer.setActionName("scaleInEffectForWebService");
