...
public class ActionEffect {
	...
	public void aggregateMetrics(Node currentEntity,SyblAPIService syblAPI){
	...
	public void refreshMetricsForAboveLevels(DependencyGraph dependencyGraph,SyblAPIService syblAPI){
...
//		PlanningLogger.logger.error("Entity id is "+currentEntityID);
		...
		aggregateMetrics(currentEntity,syblAPI);
		...
		while (parent!=null){
			...
			aggregateMetrics(parent,syblAPI);
